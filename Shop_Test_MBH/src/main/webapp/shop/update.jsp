...
<body>
	...
	<script type="text/javascript">
		function showProductDetails() {
			if(document.getElementById('condition-new').value == '<%=product.getCondition()%>')
	        	document.getElementById('condition-new').checked = true;
			if(document.getElementById('condition-old').value == '<%=product.getCondition()%>')
	        	document.getElementById('condition-old').checked = true;
			if(document.getElementById('condition-re').value == '<%=product.getCondition()%>')
	        	document.getElementById('condition-re').checked = true;
	    }
